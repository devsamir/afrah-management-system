...
import { usePenjahitSarung } from "../../hooks/Sarung/penjahitSarungHooks";
...
const PenjahitSarung = () => {
  const State = usePenjahitSarung();
      ...
      <div>
        ...
        <div className="my-4">
          <Table
            ...
            label="(By: Nama Penjahit, KTP, No Telpon)"
          />
        </div>
      </div>
          ...
          <Form>
            <Modal.Header>
              <Modal.Title className="text-capitalize">
                {inputStatus} data penjahit sarung
              </Modal.Title>
            </Modal.Header>
            <Modal.Body>
              <div className="form-group my-2">
                <label>
                  Nama Penjahit<span className="text-danger">*</span>
                </label>
                <Field
                  className="form-control"
                  name="namaPenjahit"
                  placeholder="Masukan Nama Penjahit"
                />
              </div>
              <div className="form-group my-2">

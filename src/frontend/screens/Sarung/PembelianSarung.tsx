...
import { usePembelianSarung } from "../../hooks/Sarung/pembelianSarungHooks";
...
const columns: Columns[] = [
  ...
  { field: "namaPabrik", headerName: "Nama Pabrik" },
...
const PembelianSarung = () => {
  const State = usePembelianSarung();
  ...
  const [pabrik, setPabrik] = useState<any>({});
  ...
  const [pabrikP, setPabrikP] = useState("");
  // Input Piutang
  ...
  const handleUpdate = async () => {
    ...
    if (one) {
      ...
      setPabrik({ value: one.idPabrik, label: one.namaPabrik });
  ...
  const handleGetPiutang = async () => {
    ...
    if (piutang) {
      setPabrikP(piutang.pembelian.namaPabrik);
      setTanggalP(piutang.pembelian.tanggal);
      setWarnaSarungP(piutang.pembelian.warnaSarung);
      setHargaP(piutang.pembelian.harga);
      setJumlahP(piutang.pembelian.jumlah);
      setTotalP(piutang.pembelian.total);
      setTagihanP(piutang.pembelian.sisaTagihan);
      setKeteranganP(piutang.pembelian.keterangan);
            ...
            <div style={{ width: 200 }} className="mx-2">
              ...
              <Select
                ...
                options={[
                  ...
                  ...State.pabrikFilter.map((item) => ({
                    value: item.id,
                    label: item.namaPabrik,
                  })),
                ]}
        ...
        <form onSubmit={handleSubmit}>
          ...
          <Modal.Body>
            ...
            <div className="form-group my-2">
              ...
              <Select
                value={pabrik}
                options={State.pabrikAdd.map((item) => ({
                  value: item.id,
                  label: item.namaPabrik,
                }))}
                onChange={(value) => setPabrik(value)}
              />
            </div>
            <div className="form-group my-2">
              <label>
      ...
      >
        ...
        <Modal.Body>
          <div className="row">
            <div className="col-6">
              <label>Pabrik</label>
              <input type="text" className="form-control" value={pabrikP} />
            </div>
            <div className="col-6">
              <label>Tanggal</label>
        ...
        <div className="bg-white p-5" ref={printRef}>
          <div>
            <h4 className="text-center custom-title-black mb-4">
              Laporan Pembelian Sarung Afrah Collections
            </h4>
          </div>
            ...
            <tbody>
              {State.dataPrint.map((item) => (
                <tr key={item.id}>
                  ...
                  <td className="custom-text-black">{item.namaPabrik}</td>
...
export default PembelianSarung;

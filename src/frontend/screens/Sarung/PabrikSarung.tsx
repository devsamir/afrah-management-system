...
import { usePabrikSarung } from "../../hooks/Sarung/pabrikSarungHooks";
      ...
      <div>
        ...
        <div className="my-4">
          <Table
            ...
            label="(By: Nama Pabrik & No Telpon)"
          />
        </div>
      </div>
          ...
          <Form>
            <Modal.Header>
              <Modal.Title className="text-capitalize">
                {inputStatus} data pabrik sarung
              </Modal.Title>
            </Modal.Header>
            <Modal.Body>
              <div className="form-group my-2">
                <label>
                  Nama Pabrik<span className="text-danger">*</span>
                </label>
                <Field

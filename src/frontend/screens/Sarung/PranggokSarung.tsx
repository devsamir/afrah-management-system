...
import { usePranggokSarung } from "../../hooks/Sarung/pranggokSarungHooks";
      ...
      <div>
        ...
        <div className="my-4">
          <Table
            ...
            label="(By: Nama Pranggok, KTP, No Telpon)"
          />
        </div>
      </div>
          ...
          <Form>
            <Modal.Header>
              <Modal.Title className="text-capitalize">
                {inputStatus} data pranggok sarung
              </Modal.Title>
            </Modal.Header>
            <Modal.Body>
              <div className="form-group my-2">
                <label>
                  Nama Pranggok<span className="text-danger">*</span>
                </label>
                <Field
                  className="form-control"
                  name="namaPranggok"
                  placeholder="Masukan Nama Pranggok"
                />
              </div>
              <div className="form-group my-2">
